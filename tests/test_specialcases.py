...
class SpecialTest(unittest.TestCase):
    ...
    def testcell2prn(self):  # test cell2prn helper method using signal RINEX code
        EXPECTED_RESULT = [
    ...
    def testcell2prn2(self):  # test cell2prn helper method using frequency band
        EXPECTED_RESULT = [
            "{1: ('006', 'L1'), 2: ('006', 'L2'), 3: ('006', 'L5'), 4: ('011', 'L1'), 5: ('011', 'L2'), 6: ('011', 'L5'), 7: ('012', 'L1'), 8: ('012', 'L2'), 9: ('017', 'L1'), 10: ('017', 'L2'), 11: ('019', 'L1'), 12: ('019', 'L2'), 13: ('020', 'L1'), 14: ('020', 'L2'), 15: ('024', 'L1'), 16: ('024', 'L2'), 17: ('024', 'L5'), 18: ('025', 'L1'), 19: ('025', 'L2'), 20: ('025', 'L5')}",
            "{1: ('002', 'G1'), 2: ('002', 'G2'), 3: ('009', 'G1'), 4: ('009', 'G2'), 5: ('015', 'G1'), 6: ('015', 'G2'), 7: ('016', 'G1'), 8: ('016', 'G2'), 9: ('017', 'G1'), 10: ('017', 'G2'), 11: ('018', 'G1'), 12: ('018', 'G2'), 13: ('019', 'G1'), 14: ('019', 'G2')}",
            "{1: ('002', 'E1'), 2: ('002', 'E6'), 3: ('002', 'E5AB'), 4: ('010', 'E1'), 5: ('010', 'E6'), 6: ('010', 'E5AB'), 7: ('011', 'E1'), 8: ('011', 'E6'), 9: ('011', 'E5AB'), 10: ('012', 'E1'), 11: ('012', 'E6'), 12: ('012', 'E5AB'), 13: ('024', 'E1'), 14: ('024', 'E6'), 15: ('024', 'E5AB'), 16: ('025', 'E1'), 17: ('025', 'E6'), 18: ('025', 'E5AB'), 19: ('036', 'E1'), 20: ('036', 'E6'), 21: ('036', 'E5AB')}",
        ]
